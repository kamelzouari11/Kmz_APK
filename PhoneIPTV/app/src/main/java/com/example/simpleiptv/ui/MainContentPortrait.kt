    ...
    Box(modifier = Modifier.fillMaxSize()) {
        if (!viewModel.isShowingChannelsPortrait) {
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                val currentChannels = viewModel.lastList
                ...
                if (isVod) {
                            ...
                            BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
                                ...
                                if (isGridView) {
                                    ...
                                    LazyVerticalGrid(
                                        ...
                                        gridItems(currentChannels, key = { "${it.profileId}_${it.stream_id}" }) {
                                                channel ->
                                            val isPlaying =
                                            ...
                                            VodItem(
                                                    ...
                                                    profile = viewModel.profiles.find { it.id == channel.profileId }
                                            )
                                        }
                                    }
                                } else {
                                    ...
                                    LazyColumn(
                                        ...
                                        lazyItems(currentChannels, key = { "${it.profileId}_${it.stream_id}" }) {
                                                channel ->
                                            val isPlaying =
                                                    viewModel.playingChannel?.stream_id ==
                                                            channel.stream_id
                    ...
                    LazyColumn(
                        ...
                        lazyItems(currentChannels, key = { "${it.profileId}_${it.stream_id}" }) { channel ->
