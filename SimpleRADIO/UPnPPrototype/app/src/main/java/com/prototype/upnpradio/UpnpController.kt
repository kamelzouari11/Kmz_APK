 ...
 */
class UpnpController(private val listener: Listener) {

    companion object {
        private const val TAG = "UpnpController"
        private const val SOAP_TIMEOUT_MS = 8000

        // The single hardcoded radio URL for the prototype
        const val RADIO_URL = "https://stream.regenbogen2.de/exclassicrock/mp3-128/"
        const val RADIO_NAME = "Regenbogen 2 - Classic Rock"
        const val CONTENT_TYPE = "audio/mpeg"
        const val RADIO_LOGO_URL = "https://www.regenbogen.de/sites/default/files/logo-fb-rb2.png"
    }
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                if (proxy.getLogoUrl() == null) {
                    ...
                    proxy.setLogoFromResource(R.drawable.ic_radio_logo)
                }
    ...
    private fun buildDidlLiteMetadata(streamUrl: String): String {
        ...
        return "<DIDL-Lite xmlns=\"urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/\" " +
                ...
                "<dc:title>$RADIO_NAME</dc:title>" +
                "<upnp:artist>UPnP Prototype</upnp:artist>" +
                "<upnp:album>Live Streaming</upnp:album>" +
                logoTag +
                "<res duration=\"0:00:00\" protocolInfo=\"http-get:*:$CONTENT_TYPE:*\">$streamUrl</res>" +
                "</item>" +
                "</DIDL-Lite>"
    }
