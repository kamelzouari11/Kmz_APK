...
data class ApiFootballLeagueEntryDto(
    ...
    val seasons: List<ApiFootballLeagueSeasonDto> = emptyList()
)

@JsonClass(generateAdapter = true)
data class ApiFootballLeagueSeasonDto(
    val year: Int,
...
data class ApiFootballTeamsResponse(
    val response: List<ApiFootballTeamEntryDto>
)

@JsonClass(generateAdapter = true)
data class ApiFootballTeamEntryDto(
